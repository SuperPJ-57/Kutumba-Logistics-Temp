...
public class TripCommandValidator : AbstractValidator<TripCommand>
{
    ...
    public TripCommandValidator(ITripRequestRepository tripRequestRepository)
    {
        ...
        RuleFor(x => x.DriverAllownace).NotEmpty().WithMessage("DriverAllowance Fee is Required.");
